...
static void ble_print_conn_desc(struct ble_gap_conn_desc *desc)
{
    ...
    ESP_LOGI(s_tag, " our_id_addr_type=%d our_id_addr=", desc->our_id_addr.type);
    print_addr(desc->our_id_addr.val);

    ESP_LOGI(s_tag, " peer_ota_addr_type=%d peer_ota_addr=", desc->peer_ota_addr.type);
    print_addr(desc->peer_ota_addr.val);

    ESP_LOGI(s_tag, " peer_id_addr_type=%d peer_id_addr=", desc->peer_id_addr.type);
